...
resource.AddFile("materials/VGUI/ttt/icon_health_grenade.vmt")
end
...
SWEP.SlotPos            = 0
   ...
   SWEP.EquipMenuData = {
      type = "Grenade",
      desc = "Heals health over time (2 per second) in the red cloud."
   };
   
end
SWEP.Icon = "VGUI/ttt/icon_health_grenade"
